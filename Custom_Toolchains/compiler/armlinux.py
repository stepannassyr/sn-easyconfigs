...
##
"""
Support for ARM compiler for Linux (armclang) as toolchain compiler.
Base on clang.py
...
class ArmLinuxcompiler(Compiler):
    """ArmLinux compiler class"""

    COMPILER_MODULE_NAME = ['armlinux']
    COMPILER_FAMILY = TC_CONSTANT_ARMLINUX
    ...
    def _set_compiler_vars(self):
        ...
        super(ArmLinuxcompiler, self)._set_compiler_vars()
