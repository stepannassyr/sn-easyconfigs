...
##
"""
EasyBuild support for ARM Compiler for Linux toolchain.

:author: Stepan Nassyr (Forschungszentrum Juelich)
"""

from easybuild.toolchains.compiler.armlinux import ArmLinuxcompiler
from easybuild.tools.toolchain.toolchain import SYSTEM_TOOLCHAIN_NAME

TC_CONSTANT_ARMLINUX = 'ArmLinux'

class ArmLinux(ArmLinuxcompiler):
    """Compiler-only toolchain, including only ARM Compiler for Linux."""
    NAME = 'armlinux'
    TOOLCHAIN_FAMILY = TC_CONSTANT_ARMLINUX
